...
namespace SummonManager
{
    public partial class ShowSummonOTK : Form
    {
        ...
        private void bAdd_Click(object sender, EventArgs e)//сохранить и передать на коммерческий отдел
        {
            if (this.SVO.IDSTATUS != 7)
            {
            ...
            if (MessageBox.Show("Вы действительно хотите сохранить и передать в коммерческий отдел?", "Внимание!", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.No)
            {
                return;
            }
